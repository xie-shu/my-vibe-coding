...
- 每日自动轮换：题目和首页热点按日期稳定切换，同一天不乱变，第二天自动更新；
- 答案评分与复盘：输出评分、优点、不足、优化方向和参考答案；
- 面试复盘库：推荐上传飞书妙记导出的 TXT/MD 转写文本，平台区分“面试官 / 我”、逐题分析回答并生成参考答案；音频直传保留为 Demo/后续 ASR 方向；
...
| 面试库 `/interviews` | 上传飞书妙记文本或面试音频 Demo，查看说话人分离逐字稿、问题分析和参考答案 |
